...
type AddEquipmentStepTwoProps = {
    onNext: (data: z.infer<typeof addquipmentStepTwoSchema>) => void
    onBack: () => void
    className?: string
}
...
export default function AddEquipmentStepTwo({
    ...
    className,
    ...props
}: AddEquipmentStepTwoProps) {

    const form = useForm<z.infer<typeof addquipmentStepTwoSchema>>({
        resolver: zodResolver(addquipmentStepTwoSchema),
        defaultValues: {},
    })

    function onSubmit(data: z.infer<typeof addquipmentStepTwoSchema>) {
        onNext(data)
    }
